...
const wordsList1 = [
    ...
    { word: "Pope Gregory", pos: "n.", pronunciation: "[poʊp ˈɡreɡəri]", eng: "the head of the Catholic Church who introduced the Gregorian calendar.", eng_vie: "(Giáo hoàng Gregory)", ex: "Pope Gregory changed the calendar in 1582.", ex_vie: "(Giáo hoàng Gregory đã thay đổi lịch vào năm 1582.)" },
    { word: "Christian", pos: "adj.", pronunciation: "[ˈkrɪstʃən]", eng: "relating to or professing Christianity.", eng_vie: "(thuộc đạo Cơ đốc)", ex: "They celebrate many Christian holidays.", ex_vie: "(Họ kỷ niệm nhiều ngày lễ của đạo Cơ đốc.)" },
    ...
    { word: "geese", pos: "n.", pronunciation: "[ɡiːs]", eng: "plural of goose.", eng_vie: "((số nhiều của goose) ngỗng)", ex: "The geese honked loudly.", ex_vie: "(Những con ngỗng kêu inh ỏi.)" },
...
const wordsList2 = [
    ...
    { word: "elaborate", pos: "adj.", pronunciation: "[ɪˈlæbərət]", eng: "involving many carefully arranged parts or details.", eng_vie: "(kỹ lưỡng, công phu)", ex: "She made elaborate preparations for the party, and then no one came.", ex_vie: "(Cô ấy đã chuẩn bị kỹ lưỡng cho bữa tiệc, và sau đó không có ai đến.)" },
    { word: "Rhode Island", pos: "n.", pronunciation: "[roʊd ˈaɪlənd]", eng: "a state in the New England region of the US.", eng_vie: "(tiểu bang Rhode Island)", ex: "The salesman is from Rhode Island.", ex_vie: "(Người nhân viên bán hàng đến từ Rhode Island.)" },
    ...
    { word: "crazy", pos: "adj.", pronunciation: "[ˈkreɪzi]", eng: "mad, especially as manifested in wild or aggressive behavior.", eng_vie: "(điên)", ex: "The girl was a bit crazy.", ex_vie: "(Cô gái đó hơi điên một chút.)" },
    { word: "screwball", pos: "n.", pronunciation: "[ˈskruːbɔːl]", eng: "an erratic or unconventional person.", eng_vie: "(người gàn dở)", ex: "She was a real screwball.", ex_vie: "(Cô ấy là một người thực sự gàn dở.)" },
    ...
    { word: "pregnant", pos: "adj.", pronunciation: "[ˈpreɡnənt]", eng: "having a child or young developing in the uterus.", eng_vie: "(có thai)", ex: "She told her boyfriend she was pregnant.", ex_vie: "(Cô nói với bạn trai rằng mình đã có thai.)" },
    ...
    { word: "right", pos: "adv.", pronunciation: "[raɪt]", eng: "exactly; completely.", eng_vie: "(vẫn, hoàn toàn, ngay)", ex: "He kept right on going.", ex_vie: "(Anh ấy vẫn tiếp tục tiến lên.)" },
  ...
  "parts": [
    {
      ...
      "sections": [
        {
          "content": "<p class=\"font-bold text-lg text-slate-800 mb-2 mt-4\">Task 1</p><p class=\"font-bold text-[16px] text-slate-800 mb-4\">Listen carefully and fill the missing words from the word list into the blanks to complete the sentence.</p><p>1. Earning a living is a [ 1 ] matter.</p><p>2. When visiting a foreign country, we must respect the country's [ 2 ].</p><p>3. The student organization is effective in ensuring that the students [ 3 ] school regulations.</p><p>4. He got the money by a [ 4 ].</p><p>5. She [ 5 ] her trip to New York as she felt ill.</p>",
          "questions": [
            {
              "id": qId++,
              ...
              "options": [],
              "answer": "practical",
              "explanation": "<b>Practical</b> (adj.): thực tế. Kiếm sống là một vấn đề thực tế."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "customs",
              "explanation": "<b>Custom</b> (n.): phong tục, tập quán. Khi đi du lịch nước ngoài, chúng ta phải tôn trọng phong tục của đất nước đó."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "observe",
              "explanation": "<b>Observe</b> (v.): tuân theo. Tổ chức sinh viên rất hiệu quả trong việc đảm bảo sinh viên tuân thủ nội quy nhà trường."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "trick",
              "explanation": "<b>Trick</b> (n.): trò lừa gạt, chơi xỏ. Anh ta đã lấy được tiền nhờ một trò lừa gạt."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "cancelled",
              "explanation": "<b>Cancel</b> (v.): hủy bỏ. Cô ấy đã hủy chuyến đi New York vì cảm thấy không khỏe."
            }
          ]
        }
      ]
    },
    {
      ...
      "sections": [
        {
          "content": "<p class=\"font-bold text-lg text-slate-800 mb-2 mt-4\">Task 2</p><p class=\"font-bold text-[16px] text-slate-800 mb-4\">Listen carefully and fill the missing words from the word list into the blanks to complete the sentence.</p><p>6. They hanged an [ 1 ] man.</p><p>7. He [ 2 ] the shoe with newspapers.</p><p>8. I'm sorry, I didn't [ 3 ] to imply that you were dishonest.</p><p>9. The [ 4 ] of the salesman turned out to be disastrous.</p><p>10. Sometimes a thing is [ 5 ] but intriguing.</p>",
          "questions": [
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "innocent",
              "explanation": "<b>Innocent</b> (adj.): ngây thơ, vô tội. Họ đã treo cổ một người đàn ông vô tội."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "stuffed",
              "explanation": "<b>Stuff</b> (v.): nhồi nhét. Anh ta nhét đầy giấy báo vào chiếc giày."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "mean",
              "explanation": "<b>Mean</b> (v.): có ý định. Tôi xin lỗi, tôi không có ý ám chỉ bạn là người không trung thực."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "deception",
              "explanation": "<b>Deception</b> (n.): sự lừa dối. Sự lừa gạt của nhân viên bán hàng hóa ra lại là một thảm họa."
            },
            {
              "id": qId++,
              "questionType": "Điền từ",
              ...
              "options": [],
              "answer": "absurd",
              "explanation": "<b>Absurd</b> (adj.): phi lý. Đôi khi một điều gì đó thật phi lý nhưng lại đầy hấp dẫn."
            }
          ]
        }
      ]
          ...
          "questions": [
            {
              ...
              "content": "April Fools' Day originated in France in 1582 due to a change in the calendar.",
              "options": ["True", "False", "Not Given"],
              "answer": "True",
              "explanation": "<b>True</b>. The text says: 'The origin of the custom is uncertain, but it seems to have come about in France as a result of change to the Gregorian calendar in 1582.'"
            },
            {
              "id": qId++,
              "questionType": "Droplist",
              "content": "A common trick in France today is pointing at someone's shoe and saying it is untied.",
              "options": ["True", "False", "Not Given"],
              "answer": "False",
              "explanation": "<b>False</b>. The text says this is a common trick in America: 'Today Americans play small tricks on friends... One common trick is pointing down to a friend's shoe...'"
            },
            {
              "id": qId++,
              "questionType": "Droplist",
              "content": "Receiving an April Fool letter is considered an insult.",
              "options": ["True", "False", "Not Given"],
              "answer": "False",
              "explanation": "<b>False</b>. The text states: 'To receive an April Fool letter... is deemed a most flattering honor...'"
            },
            {
              "id": qId++,
              "questionType": "Droplist",
              "content": "April Fool tricks are strictly for children and not played in professional offices.",
              "options": ["True", "False", "Not Given"],
              "answer": "False",
              "explanation": "<b>False</b>. The text clearly says: 'April Fool tricks are not, it seems, confined to children. People play tricks in the office.'"
            }
          ]
        }
      ]
...
console.log('Unit 3 generated successfully.');
