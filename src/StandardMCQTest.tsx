...
// =========================================================================================
export default function StandardMCQTest({ 
    onBack, 
    testData, 
    onFinish 
}: { 
                             ...
                             {(() => {
                               ...
                               return (
                                 <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border-2 border-slate-200 mb-6">
                                   ...
                                   {/* Review mode word bank (read-only) */}
                                   {isReviewMode && (
                                     <div className="mt-8 p-5 bg-slate-50 border border-slate-200 rounded-xl font-sans">
                                         ...
                                         {(() => {
                                           ...
                                           return allOpts.map((opt: string, oIdx: number) => {
                                             ...
                                             return (
                                               <div
                                                 key={oIdx}
                                                 className="px-4 py-2 font-bold font-sans text-[14px] border border-slate-200 rounded-lg bg-slate-50 text-slate-500 cursor-default select-none shadow-sm"
                                               >
                                                 {displayOpt}
                                               </div>
                                             );
